...
public class SpectacleFormController {
    ...
    private Spectacle spectacle; // spectacle en cours d’édition
    ...
    public void initialize() {
        ...
        spinnerDuree.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(30, 300, 90)); // durée par défaut : 90 min
        spinnerAgeMinimum.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(0, 18, 0)); // âge min par défaut : 0
    }
    ...
    private void saveSpectacle() {
        try {
            ...
            if (spectacle == null) {
                ...
                spectacleDAO.addSpectacle(newSpectacle);
            } else {
