...
public class ClientFormController {
    ...
    public void setExistingClient(Client client) {
        ...
        if (client != null) {
            ...
            fieldNumTel.setText(client.getNumTel()); // ✅ cohérent : String
        }
    }
    ...
    private void save() {
        ...
        String numTel = fieldNumTel.getText().trim(); // ✅ String

        if (prenom.isEmpty() || nom.isEmpty() || email.isEmpty() || numTel.isEmpty()) {
